...
df_est = pd.read_csv('../clean_data/current_estimated_values.csv')
df_age = pd.read_csv('../clean_data/clean_data_epiweek-weekly-incidence.csv')
...
df_age_full.to_csv('../clean_data/clean_data_epiweek-weekly-incidence_w_situation.csv')